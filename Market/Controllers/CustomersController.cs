...
namespace Market.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public ActionResult Create()
        {
           ...
           //Agregar una anotacion, para que no truene el sistema
           //Cuando no seleccione un tipo de documento.
           
            var list = db.DocumentTypes.ToList();
            list.Add(new DocumentType { DocumentTypeID = 0, Description = "[Selecciona un documento...]" });
